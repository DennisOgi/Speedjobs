                            ...
                            <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                                ...
                                @else
                                    <form action="{{ route('workshops.register', $workshop) }}" method="POST">
                                        @csrf
                                        <button type="submit" class="px-8 py-3 bg-primary-600 hover:bg-primary-700 text-white rounded-xl font-bold shadow-lg shadow-primary-500/30 transition transform hover:-translate-y-0.5">
                                            Register Now
                                        </button>
                                    </form>
                                @endif
