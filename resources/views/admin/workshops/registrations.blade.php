                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                @forelse($registrations as $registration)
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="text-sm font-medium text-gray-900 dark:text-white">{{ $registration->workshop->title }}</div>
                                            <div class="text-sm text-gray-500 dark:text-gray-400">{{ $registration->workshop->start_date->format('M d, Y') }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="px-6 py-12 text-center text-gray-500 dark:text-gray-400">
                                            ...
                                            <p class="mt-4 text-lg">No registrations found</p>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
